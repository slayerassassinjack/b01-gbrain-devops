...
# ☁️ Workflow: Incident Response

> During incident: query brain → ingest findings → auto-update runbook
...
```bash
/workflows:incident-response [target] [--scope full|quick] [--output md|json|html]
```
